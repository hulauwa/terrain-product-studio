    ...
    <div class="card">
      <table>
        ...
        <tbody>
          {"".join(f"""
          <tr>
            <td><span class="badge" style="background:{row['color']}">{row['code']}</span></td>
            <td>{row['desc']}</td>
            <td><strong>{row['ha']:,.1f} ha</strong></td>
            <td><strong style="color:#58a6ff;">{row['pct']}%</strong></td>
          </tr>
    ...
    <div class="card">
      <table>
        ...
        <tbody>
          {"".join(f"""
          <tr>
            <td><span class="badge" style="background:{row['color']}; color: {'#fff' if 'Class 4' in row['code'] or 'Class 1' in row['code'] else '#000'}">{row['code']}</span></td>
            <td>{row['desc']}</td>
            <td><strong>{row['ha']:,.1f} ha</strong></td>
            <td><strong style="color:#f85149;">{row['pct']}%</strong></td>
          </tr>
